...
import { generatePhotoDetails } from '@/ai/flows/generate-photo-details-flow';
...
export default function GalleryManagementPage() {
  ...
  const handleAiEnhance = async () => {
    const photoUrl = form.getValues("url");
    if(!photoUrl || !photoUrl.startsWith("http")) {
      toast({ title: "Invalid URL", description: "Please provide a valid public photo URL to enhance with AI.", variant: "destructive"});
      return;
    }
    
    setIsGenerating(true);
    try {
        const result = await generatePhotoDetails({ photoUrl, context: 'gallery' });
        form.setValue('title', result.title, { shouldValidate: true });
        form.setValue('description', result.description, { shouldValidate: true });
        toast({ title: "Content Enhanced", description: "Title and description have been generated by AI." });
    } catch (error) {
